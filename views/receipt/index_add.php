	...
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
		<ul id="sparks" class="">
			<li class="sparks-info">
				<h5> ข้อมูลทั้งหมด <span class="txt-color-blue"><i class="fa fa-user" data-rel="bootstrap-tooltip" title="Increased"></i>&nbsp;<?php// $countAll?></span></h5>
				...
				<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1">
					...
					<div>
							...
							<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
								...
								for($i=0;$i<=(int)$_SESSION['inLineR'];$i++){
									if($_SESSION['strProductCode'][$i] != ""){
										// $idProduct = $_SESSION['strProductCode'][$i];
                    					// $model = Product::find()->where(['code'=> $idProduct])->one();
                    					// $ss['strProductId'][$i] =  $_SESSION['inLineR'][$i];
						...
						?>
						            ...
						            <tr>
								        <td><?=$i?></td>
								        <td><a herf= "#" class="act-view" data-id=''></a></td>
										<td><?=$_SESSION['strProductCode'][$i]?></td>
								        <td><?=$_SESSION['strProductUnitPrice'][$i]?></td> 
