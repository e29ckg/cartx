...
<table class="bl_detail" width="100%" border="0" cellpadding="2" cellspacing="0">
    ...
    <tr>
        ...
        <td colspan="1" class="TableLine" style="text-align:center">22</td>
        <td colspan="1" style="text-align:center">เดือน</td>
        <td colspan="1" class="TableLine" style="text-align:center">เมษายน</td>
        <td colspan="1" style="text-align:center">พ.ศ.</td>
        <td colspan="1" class="TableLine" style="text-align:center">2562</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3" class="TableLine" style="text-align:center">นางสุทธินี  ตรงชิต</td>
        <td colspan="1" >ตำแหน่ง</td>
        <td colspan="5" class="TableLine" style="text-align:center">เจ้าพนักงานศาลยุติธรรมชำนาญการพิเศษ</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="6" class="TableLine" style="text-align:center">เจ็บคอ</td>
    </tr>
    <tr>
        <td colspan="2" ></td>
    ...
    <tr>
        ...
        <td colspan="2" class="TableLine" style="text-align:center">21 เมษายน 2562 </td>
        <td colspan="1" >ถึงวันที่</td>
        <td colspan="3" class="TableLine" style="text-align:center">21 เมษายน 2562</td>
        <td colspan="2" >มีกำหนด</td>
        <td colspan="1" class="TableLine" style="text-align:center">1 </td>
        <td colspan="1" >วัน</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" >ตั้งแต่วันที่ </td>
        <td colspan="2" class="TableLine" style="text-align:center">7 ธันวาคม 2561 </td>
        <td colspan="1" >ถึงวันที่</td>
        <td colspan="3" class="TableLine" style="text-align:center">7 ธันวาคม 2561</td>
        <td colspan="2" >มีกำหนด</td>
        <td colspan="1" class="TableLine" style="text-align:center">1 </td>
        <td colspan="1" >วัน</td>
    </tr>
